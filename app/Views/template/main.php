...
<body>
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="<?= base_url() ?>/assets/javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="<?= base_url() ?>/assets/my-wallets.html">List Cabang</a></li>
    ...
    ***********************************-->
    ...
    <script data-cfasync="false" src="<?= base_url() ?>/assets/../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="<?= base_url() ?>/assets/vendor/global/global.min.js"></script>
